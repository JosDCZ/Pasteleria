              ...
              <div class="card-body col-md-6">
                <form action="panel.php?modulo=crearProducto" method="post" enctype="multipart/form-data">
                    <div class="form-group">
                        <label>Nombre</label>
                        <input type="text" name="nombre" class="form-control" placeholder="Tres Leches" required>
                    </div>

                    <div class="form-group">
                        <label>Precio</label>
                        <input type="number" step="0.01" min="0" name="precio" class="form-control" placeholder="$12.50" required>
                    </div>

                    <div class="form-group">
                        <label>Existencias</label>
                        <input type="number" min="1" name="existencia" class="form-control" placeholder="5" required>
                    </div>
